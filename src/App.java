...
// Sus atributos son: nombre, edad, DNI,

// sexo (H hombre, M mujer), peso y altura. No queremos que se accedan
// directamente a ellos. Piensa que modificador de acceso es el más adecuado,
...
// calcularIMC(): calculara si la persona esta en su peso

// ideal (peso en kg/(altura^2 en m)), si esta fórmula devuelve un valor menor
...
// sobrepeso, la función devuelve un 1. Te recomiendo que uses constantes para
